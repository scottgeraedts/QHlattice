...
a.out: main.o lattice.o berry_tests.o z_function_m.o new_coulomb_m.o wf_tools.o
	$(CC) -O3 $(CFLAGS) -fopenmp -o result z_function_m.o new_coulomb_m.o wf_tools.o lattice.o berry_tests.o main.o $(LIBS)
