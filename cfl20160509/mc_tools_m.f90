...
!  r4_random is in range [0,1] inclusive  
  call get_random(r4_random,seed)
  n = 1 + modulo(floor(nel*r4_random),nel)
  return
...
do while (num < nel)
   ...
   do while (num == n0)
      call get_random(r4_random,seed)
      i = 1 + modulo(floor(r4_random*norb),norb)
      call get_random(r4_random,seed)
      j = 1 + modulo(floor(r4_random*norb),norb)
...
real::  r4_random
call get_random(r4_random,seed)
d = step(:,1 +modulo(floor(r4_random*step_count),step_count))
return
